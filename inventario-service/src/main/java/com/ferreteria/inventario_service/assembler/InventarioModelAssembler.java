...
public class InventarioModelAssembler implements RepresentationModelAssembler<Inventario, EntityModel<Inventario>> {
    ...
    public EntityModel<Inventario> toModel(Inventario inventario) {
        return EntityModel.of(inventario,
                linkTo(methodOn(InventarioController.class).obtenerPorProductoId(inventario.getProductoId()))
                        .withSelfRel(),
                linkTo(methodOn(InventarioController.class).obtenerTodos()).withRel("todo-el-inventario"),
                linkTo(methodOn(InventarioController.class).agregarStock(inventario.getProductoId(), null))
                        .withRel("agregar-stock"),
                linkTo(methodOn(InventarioController.class).descontarStock(inventario.getProductoId(), null))

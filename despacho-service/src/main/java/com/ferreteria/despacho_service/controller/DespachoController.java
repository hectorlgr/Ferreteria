...
public class DespachoController {
        ...
        public ResponseEntity<CollectionModel<EntityModel<Despacho>>> obtenerTodos() {
                ...
                List<EntityModel<Despacho>> despachosModel = despachoService.obtenerTodos().stream()
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Despacho encontrado correctamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Despacho.class))),
        ...
        public ResponseEntity<EntityModel<Despacho>> obtenerPorPedidoId(@PathVariable Long pedidoId) {
                ...
                return ResponseEntity.ok(assembler.toModel(despacho));
        }
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Despacho(s) encontrado(s) correctamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Despacho.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Orden de despacho generada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Despacho.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Estado actualizado exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Despacho.class))),
